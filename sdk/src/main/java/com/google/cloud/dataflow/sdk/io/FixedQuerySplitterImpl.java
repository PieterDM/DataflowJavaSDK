 ...
 *
 **/
final class FixedQuerySplitterImpl implements QuerySplitter {
    ...
    static final QuerySplitter INSTANCE = new FixedQuerySplitterImpl();

    private FixedQuerySplitterImpl() {
